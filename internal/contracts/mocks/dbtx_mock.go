...
// Source: internal/contracts/dbtx.go
...
func (mr *MockDBTXMockRecorder) Query(ctx, sql interface{}, arguments ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, sql}, arguments...)
...
func (mr *MockDBTXMockRecorder) QueryRow(ctx, sql interface{}, arguments ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, sql}, arguments...)
